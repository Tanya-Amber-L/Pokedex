...
<template>
    <section class="">
        ...
        <div class="bg-white shadow text-black py-4 px-5 rounded-lg">
            <p class="flex py-1"><span class="text-gray-400 w-1/2">Type</span> 
            ...
            <p class="flex py-1"><span class="text-gray-400 w-1/2">Nummer</span> {{id}}</p>
            <p class="flex py-1"><span class="text-gray-400 w-1/2">Hoogte</span> {{height}}</p>
            <p class="flex py-1"><span class="text-gray-400 w-1/2">Gewicht</span> {{weight}}</p>
        </div>
